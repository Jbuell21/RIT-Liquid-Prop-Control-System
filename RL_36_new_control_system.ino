...
int pumpOx = 15;        // Set pin of Ox pump
int pumpFuel = 16;      // Set pin of fuel pump

int valveStatOxV1 = 0;  // Set valve states, 0 = closed, 1 = open
int valveStatFV1 = 0;
int valveStatFV2 = 0;
int valveStatPV = 0;
...
void loop() {
  ...
  // Close fuel and ox solenoids after 7 sec firing
  valveControl('1', 'C');
  valveControl('2', 'C');
  valveControl('3', 'C');
